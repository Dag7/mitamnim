  ...
  return (
    ...
    >
      <div ref={modalRef} className="bg-white rounded-2xl max-w-[800px] w-full max-h-[90vh] overflow-y-auto p-8" dir="rtl">
        ...
        <h3 className="text-navy border-r-4 border-orange pr-3 mt-5 font-bold">12. ציוד ביתי ואחריות המתאמן/ת</h3>
        <p className="mb-4">האימונים מתבצעים בבית המתאמן/ת תוך שימוש בציוד אישי בלבד – משקולות, אביזרי אימון, חפצים מאולתרים (בקבוקי מים, קופסאות שימורים, תיק משקל וכד&rsquo;) או כל אביזר אחר. המתאמן/ת מצהיר/ה כי הציוד תקין ומתאים, וכי סביבת האימון בטוחה ופנויה ממכשולים. האחריות הבלעדית לבחירת הציוד, לתקינותו, להתאמתו ולשימוש בטוח בו – חלה על המתאמן/ת. נותני השירות אינם אחראים לכל נזק או פציעה הנובעים מציוד או מסביבת אימון לא מתאימים.</p>
